...
def main():
    ...
    default_dir = os.path.join(TRAINING_CONFIG["data_root"], TRAINING_CONFIG["category"])
    parser.add_argument('--data_dir', type=str, default=default_dir, help='Path (e.g., dataloader/data/chair)')
